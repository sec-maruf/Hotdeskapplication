...
from .views import desk_detail_view,desk_create_view,desk_update_view,desk_delete_view, deskbook,  solid_login_view, dashboard_view, solid_logout_view, solid_file_view
