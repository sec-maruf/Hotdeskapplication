...
from .views import  booking_confirmation, desk_detail_view,desk_create_view, desk_fetching_from_solid,desk_update_view,desk_delete_view, deskbook,  solid_login_view, dashboard_view, solid_logout_view
...
urlpatterns = [
    ...
    path('deskfetch/', desk_fetching_from_solid, name='solid-file'),
